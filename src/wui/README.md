...
| FastAPI | http://0.0.0.0:8000/audio/convert | http://0.0.0.0:8000/docs |
| DRF     | http://0.0.0.0:8000/audio/convert |                          |

<details>
 <summary>ReactJS + FastAPI + API</summary>
...
<details>
 <summary>ReactJS + DRF + API</summary>
